...
<header class="w3-container w3-highway-white w3-padding-32">
  ...
  <div class="w3-center">
  <h4 class="w3-xxxlarge w3-animate-bottom w3-blue w3-border w3-border-blue w3-round-large w3-horver-blues" style=" margin-right: auto; 
margin-left: auto;">COME AND BE A PART OF</h4>
  <h1 class="w3-xxxlarge w3-animate-bottom w3-blue w3-border w3-border-blue w3-round-large w3-horver-blues" style=" margin-right: 10em; 
margin-left: 10em;">PRAVESHA18</h1>
...
<div class="slideshow-container">
  <div class="mySlides ">
    ...
    <img src="code.jpg" style="width:50em">
    <div class="text">CODING</div>
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 10</div>
    <img src="geektalks.jpg" style="width:50em">
    <div class="text">GEEKTALKS</div>
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 10</div>
    <img src="pubg.jpg" style="width:50em">
    <div class="text">PUBG</div>
  </div>


  <div class="mySlides fade col-3 col-s-12">
    <div class="numbertext">4 / 10</div>
    <img src="quiz.jpg" style="width:50em">
  ...
  <div class="mySlides fade col-3 col-s-12">
    ...
    <img src="treasure.jpg" style="width:50em">
  ...
  <div class="mySlides fade col-3 col-s-12">
    ...
    <img src="banner.jpg" style="width:50em">
  ...
  <div class="mySlides fade col-3 col-s-12">
    ...
    <img src="ipla.jpg" style="width:50em">
  ...
  <div class="mySlides fade col-3 col-s-12">
    ...
    <img src="presentation.jpg" style="width:50em">
...
<i class="material-icons" style="font-size:85px">group</i>
<i class="material-icons" style="font-size:105px;color:red">group</i>

  <p font-family: "Times New Roman",>Standard CSS only</p>
  <p>PARTICIPATE IN OUR DIFFERENT EVENTS</p>
  <p>SPECIALLY TO HELP YOU QUENCH THAT PUBLIC SPEAKING THRIST</p>
  </div>
</div>
...
<div class="w3-third">
  <div class="w3-card w3-container w3-blue" style="min-height:460px">
  <h3>FUN</h3><br>
  <i class="material-icons" style="font-size:56px">school</i>
<i class="material-icons" style="font-size:85px">school</i>
<i class="material-icons" style="font-size:105px;color:red">schools</i>
<p>PARTICIPATE IN OUR DIFFERENT EVENTS</p>
  <p>DESIGNED ESPECIALLY FOR YOUR FUN</p>
  <p>COME GIVE US A VISIT</p>
  </div>
</div>
</div>

<div class="w3-container button">
  <button class="class="w3-button w3-xlarge w3-circle w3-black" style="display:none" id="mySidebar">
  <h1 class="w3-xxxlarge w3-text-theme w3-padding-32 font-family: calibri">PRAVESHA 18</h1>"></button>
   <button onclick="w3_close()" class="w3-button w3-xlarge w3-circle w3-black"> &times;</button>     
<a href="register.php" class="w3-btn w3-blue w3-border w3-border-blue w3-round-large w3-horver-blue">REGISTER</a>
<a href="javascript:void(0)" class=" w3-btn w3-blue w3-border w3-border-blue w3-round-large w3-horver-blue">CONTACT</a>
<a href="events.php" class="w3-btn w3-blue w3-border w3-border-blue w3-round-large w3-horver-blue">EVENTS</a>
